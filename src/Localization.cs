...
namespace CryptoMonitor
{
    internal static class Localization
    {
        ...
        static Localization()
        {
            ...
            EnglishText["TaskbarSettings"] = "Taskbar";
            ...
            EnglishText["RefreshSeconds"] = "Refresh seconds";
            EnglishText["TimeoutSeconds"] = "Timeout seconds";
            ...
            EnglishText["TaskbarWidth"] = "Width";
            ...
            EnglishText["TaskbarWidthHint"] = "Set fixed width to 0 to let the window resize to the text.";
            EnglishText["ShowTaskbarWindow"] = "Embed in taskbar";
            EnglishText["AddPreset"] = "Add";
            EnglishText["AddCustom"] = "Custom";
            ...
            EnglishText["ItemTemplateHint"] = "Example: BTC ${$.data.1.quotes.USD.price:0.00}";
            EnglishText["ItemInterval"] = "Refresh seconds";
            EnglishText["ItemTimeout"] = "Timeout seconds";
            ...
            ChineseText["TaskbarSettings"] = "任务栏";
            ...
            ChineseText["RefreshSeconds"] = "\u5237\u65b0\u95f4\u9694(\u79d2)";
            ChineseText["TimeoutSeconds"] = "\u8d85\u65f6\u65f6\u95f4(\u79d2)";
            ...
            ChineseText["TaskbarWidth"] = "宽度";
            ChineseText["TaskbarFixedWidth"] = "\u56fa\u5b9a\u5bbd\u5ea6(0=\u81ea\u52a8)";
            ChineseText["TaskbarMinWidth"] = "\u81ea\u52a8\u6700\u5c0f\u5bbd\u5ea6";
            ChineseText["TaskbarMaxWidth"] = "\u81ea\u52a8\u6700\u5927\u5bbd\u5ea6";
            ChineseText["TaskbarWidthHint"] = "固定宽度为 0 时，会根据文字自动伸缩。";
            ChineseText["ShowTaskbarWindow"] = "\u5d4c\u5165\u4efb\u52a1\u680f";
            ChineseText["AddPreset"] = "添加";
            ChineseText["AddCustom"] = "自定义";
            ...
            ChineseText["ItemTemplateHint"] = "示例：BTC ${$.data.1.quotes.USD.price:0.00}";
